...
<body>
    <span class="preheader">User fail in login in three attempts.</span>
                            ...
                            <table class="email-body_inner" align="center" width="570" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td class="content-cell">
                                        <p>User fail in login in three attempts, here's login information:</p>
                                        <table class="attributes" width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td class="attributes_content">
                                                    <table width="100%" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            <td class="attributes_item"><strong>Name:</strong> {{ $name }}</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="attributes_item"><strong>E-mail:</strong> {{ $email }}</td>
                                                        </tr>
                                                        <tr>
