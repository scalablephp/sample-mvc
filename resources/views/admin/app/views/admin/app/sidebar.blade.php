...
<div class="menu-mobile menu-activated-on-click color-scheme-dark">
    <div class="mm-logo-buttons-w">
        <a class="mm-logo" href="index-2.html"><img src="{{ URL::asset('assets/backend/img/logo.png') }}"><span>Sony Sailor</span></a>
    ...
    <div class="menu-and-user">
        <div class="logged-user-w">
            <div class="avatar-w"><img alt="" src="{{ URL::asset('assets/backend/img/avatar1.jpg') }}"></div>
        ...
        <div class="mobile-menu-magic">
            ...
            <div class="btn-w"><a class="btn btn-white btn-rounded" href="../themeforest.net/item/light-admin-clean-bootstrap-dashboard-html-template/197601240ec2?ref=Osetin" target="_blank">Purchase Now</a></div>
        </div>
    </div>
</div>
<!--END - Mobile Menu-->
...
<div class="menu-w selected-menu-color-light menu-has-selected-link menu-activated-on-click color-scheme-light color-style-transparent sub-menu-color-light menu-position-side menu-side-left menu-layout-compact sub-menu-style-inside">
    <div class="logo-w">
        <a class="logo" href="index-2.html">
            ...
            <div class="logo-label">Sony Sailor</div>
        </a>
    </div>
    <h1 class="menu-page-header">Page Header</h1>
    <ul class="main-menu">
        <li class="{{ Request::is('admin/dashboard') ? 'selected' : null }}">
            <a href="{{ url('admin/dashboard') }}">
                <div class="icon-w"><i class="fa fa-home"></i></div>
                <span>Dashboard</span>
            </a>
        </li>
        <li class="{{ Request::is('admin/users') ? 'selected' : null }}">
            <a href="{{ url('admin/users') }}">
                <div class="icon-w"><i class="fa fa-users"></i></div>
                <span>Users</span>
            </a>
        </li>
    </ul>
