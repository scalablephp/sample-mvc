        ...
        <div class="messages-notifications os-dropdown-trigger os-dropdown-position-left"><i class="os-icon os-icon-mail-14"></i>
            ...
            <div class="os-dropdown light message-list">
                <ul>
                    <li>
                        <a href="#">
                            <div class="user-avatar-w"><img alt="" src="{{ URL::asset('assets/backend/img/avatar1.jpg') }}"></div>
                    ...
                    <li>
                        <a href="#">
                            <div class="user-avatar-w"><img alt="" src="{{ URL::asset('assets/backend/img/avatar2.jpg') }}"></div>
                            <div class="message-content">
                    ...
                    <li>
                        <a href="#">
                            <div class="user-avatar-w"><img alt="" src="{{ URL::asset('assets/backend/img/avatar3.jpg') }}"></div>
                            <div class="message-content">
                    ...
                    <li>
                        <a href="#">
                            <div class="user-avatar-w"><img alt="" src="{{ URL::asset('assets/backend/img/avatar4.jpg') }}"></div>
                            <div class="message-content">
