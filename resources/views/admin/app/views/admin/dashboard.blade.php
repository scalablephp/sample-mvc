                        ...
                        <table class="table table-lightborder">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="cell-image-list">
                                            <div class="cell-img" style="background-image: url({{ URL::asset('assets/backend/img/portfolio9.jpg') }})"></div>
                                            <div class="cell-img" style="background-image: url({{ URL::asset('assets/backend/img/portfolio2.jpg') }})"></div>
                                            <div class="cell-img" style="background-image: url({{ URL::asset('assets/backend/img/portfolio12.jpg') }})"></div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="cell-image-list">
                                            <div class="cell-img" style="background-image: url({{ URL::asset('assets/backend/img/portfolio14.jpg') }})"></div>
                                            <div class="cell-img" style="background-image: url({{ URL::asset('assets/backend/img/portfolio8.jpg') }})"></div>
                                        </div>
                                    </td>
                                    <td class="text-center">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="cell-image-list">
                                            <div class="cell-img" style="background-image: url({{ URL::asset('assets/backend/img/portfolio16.jpg') }})"></div>
                                            <div class="cell-img" style="background-image: url({{ URL::asset('assets/backend/img/portfolio14.jpg') }})"></div>
                                            <div class="cell-img" style="background-image: url({{ URL::asset('assets/backend/img/portfolio5.jpg') }})"></div>
                                        </div>
                                    </td>
                                    <td class="text-center">
                                        <div class="status-pill green" data-title="Complete" data-toggle="tooltip"></div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="cell-image-list">
                                            <div class="cell-img" style="background-image: url({{ URL::asset('assets/backend/img/portfolio1.jpg') }})"></div>
                                            <div class="cell-img" style="background-image: url({{ URL::asset('assets/backend/img/portfolio5.jpg') }})"></div>
                                            <div class="cell-img" style="background-image: url({{ URL::asset('assets/backend/img/portfolio6.jpg') }})"></div>
                        ...
                        <table class="table table-bordered table-lg table-v2 table-striped">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>John Mayers</td>
                                    <td><img alt="" src="{{ URL::asset('assets/backend/img/flags-icons') }}/us.png" width="25px"></td>
                                ...
                                <tr>
                                    ...
                                    <td>Mike Astone</td>
                                    <td><img alt="" src="{{ URL::asset('assets/backend/img/flags-icons') }}/fr.png" width="25px"></td>
                                ...
                                <tr>
                                    ...
                                    <td>Jessica Bloom</td>
                                    <td><img alt="" src="{{ URL::asset('assets/backend/img/flags-icons') }}/ca.png" width="25px"></td>
            ...
            <div class="chat-head">
                <div class="user-w with-status status-green">
                    <div class="user-avatar-w">
                        <div class="user-avatar"><img alt="" src="{{ URL::asset('assets/backend/img/avatar1.jpg') }}"></div>
                    </div>
                    <div class="user-name">
        ...
        <div class="element-box-tp">
            <div class="profile-tile">
                <a class="profile-tile-box" href="users_profile_small.html">
                    <div class="pt-avatar-w"><img alt="" src="{{ URL::asset('assets/backend/img/avatar1.jpg') }}"></div>
            ...
            <div class="profile-tile">
                <a class="profile-tile-box" href="users_profile_small.html">
                    <div class="pt-avatar-w"><img alt="" src="{{ URL::asset('assets/backend/img/avatar3.jpg') }}"></div>
            ...
            <div class="activity-boxes-w">
                <div class="activity-box-w">
                    ...
                    <div class="activity-box">
                        <div class="activity-avatar"><img alt="" src="{{ URL::asset('assets/backend/img/avatar1.jpg') }}"></div>
                ...
                <div class="activity-box-w">
                    ...
                    <div class="activity-box">
                        <div class="activity-avatar"><img alt="" src="{{ URL::asset('assets/backend/img/avatar2.jpg') }}"></div>
                        <div class="activity-info">
                ...
                <div class="activity-box-w">
                    ...
                    <div class="activity-box">
                        <div class="activity-avatar"><img alt="" src="{{ URL::asset('assets/backend/img/avatar3.jpg') }}"></div>
                        <div class="activity-info">
                ...
                <div class="activity-box-w">
                    ...
                    <div class="activity-box">
                        <div class="activity-avatar"><img alt="" src="{{ URL::asset('assets/backend/img/avatar4.jpg') }}"></div>
                        <div class="activity-info">
    ...
    <div class="element-wrapper">
        ...
        <div class="element-box-tp">
            ...
            <div class="users-list-w">
                ...
                <div class="user-w with-status status-green">
                    <div class="user-avatar-w">
                        <div class="user-avatar"><img alt="" src="{{ URL::asset('assets/backend/img/avatar2.jpg') }}"></div>
                    </div>
                    <div class="user-name">
                ...
                <div class="user-w with-status status-red">
                    <div class="user-avatar-w">
                        <div class="user-avatar"><img alt="" src="{{ URL::asset('assets/backend/img/avatar3.jpg') }}"></div>
                    </div>
                    <div class="user-name">
                ...
                <div class="user-w with-status status-green">
                    <div class="user-avatar-w">
                        <div class="user-avatar"><img alt="" src="{{ URL::asset('assets/backend/img/avatar4.jpg') }}"></div>
                    </div>
                    <div class="user-name">
