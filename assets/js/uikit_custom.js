...
(function(addon) {
    ...
    UI.component('autocomplete', {
        ...
        defaults: {
            ...
            template: '<ul class="uk-nav uk-nav-autocomplete uk-autocomplete-results">{{~items}}<li data-value="{{$item.value}}" data-id="{{$item.title}}"><a>{{$item.value}}</a></li>{{/items}}</ul>'
        },
        ...
        select: function() {
            ...
            if (data.value) {
                ...
                this.input.attr('data-id',data.id);
            }
