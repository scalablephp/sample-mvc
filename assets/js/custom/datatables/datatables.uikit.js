...
(function(window, document, undefined){
    ...
    var factory = function( $, DataTable ) {
        ...
        $.extend( true, DataTable.defaults, {
            ...
            renderer: 'uikit',
            language: {
                "lengthMenu": Lang.get('strings.show') + "_MENU_" + Lang.get('strings.item_per_page'),
                "info": Lang.get('strings.showing') + "_START_ - _END_" + Lang.get('strings.of') + "_TOTAL_" + Lang.get('strings.item'),
                "infoEmpty": Lang.get('strings.showing') + "0" + Lang.get('strings.to') + "0"  + Lang.get('strings.of') + "0" + Lang.get('strings.item'),
                //"infoFiltered": "(filtered from _MAX_ total items)",
                "infoFiltered": "",
                "sSearch": Lang.get('strings.search'),
                "paginate": {
                  "previous": Lang.get('strings.prev'),
                  "next": Lang.get('strings.next'),
                }
            },
            pageLength: 5,
            pagingType: "input",
